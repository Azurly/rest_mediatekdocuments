...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 19 fév. 2024 à 15:33
...
CREATE TABLE IF NOT EXISTS `suivi` (
  `id` int(11) NOT NULL,
  `etat` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('0001', 'Pitt', 'Brad', 'bradpitt@outlook.com', 'bg', '0001'),
('0002', 'testNom', 'TestPrenom', 'test@mail.fr', 'test', '0002'),
('0003', 'DURAND', 'Julien', 'durandjulien@mail.fr', 'djulien', '0003'),
('0004', 'DUPOND', 'Marie', 'mariedupond@mail.fr', 'dmarie', '0004');
